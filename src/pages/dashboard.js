...
export default function Dashboard() {
  ...
  function Applicants() {
    fetch("http://localhost:1337/api/applicantlist")
      .then((res) => res.json())
      .then((list) => {
  ...
  function open() {
    fetch("http://localhost:1337/api/joblist")
      .then((res) => res.json())
      .then((list) => {
  ...
  const update = async (id) => {
    const requestOptions = {
      ...
      body: '{"data":{"AppStatus":"Approved"}}',
    };
    console.log(requestOptions);
    fetch("http://localhost:1337/api/applicantlist/" + id, requestOptions)
  ...
  const addjob = async () => {
    ...
    // console.log(requestOptions)
    fetch("http://localhost:1337/api/joblist", requestOptions).then(
    ...
    <div>
      ...
      <div className="job2">
        ...
        {Applicant.map((list, i) => {
          // if (list.attributes.AppStatus === "Pending") {
            return (
              <div key={i}>
                <div>
